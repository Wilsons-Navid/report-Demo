      ...
      <section className="px-6 pt-32">
        ...
        <Reveal delay={0.1} className="mx-auto mt-12 max-w-5xl">
          <div className="glass-card overflow-hidden rounded-3xl p-2">
            ...
            <img src="/img/africa-street.jpg" alt="Hands exchanging banknotes at a market stall in daylight" className="h-64 w-full rounded-[1.1rem] object-cover object-center md:h-80" />
          </div>
        </Reveal>
      </section>
